            ...
            >
                ...
                <div className="mt-12 pt-8 border-t border-white/10">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {post.tags.map(tag => (
                            <span key={tag} className="px-3 py-1 bg-slate-800/60 border border-white/[0.06] rounded-lg text-[11px] font-medium text-slate-300 hover:border-cyan-500/30 transition-colors">
                                #{tag}
                            </span>
                        ))}
                    </div>
