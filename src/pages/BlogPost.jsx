...
const BlogPost = () => {
    ...
    return (
        <article className="min-h-screen bg-[#0a0514] pb-32">
            ...
            <motion.div 
                className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-600 to-yellow-400 origin-left z-50"
                style={{ scaleX }}
            />

            {/* Hero Section */}
            <div className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <Link to="/blog" className="inline-flex items-center gap-2 text-slate-400 hover:text-yellow-400 mb-8 transition-colors font-bold group">
                ...
                <div className="relative w-full h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(139,92,246,0.15)] group">
                    ...
                    {post.image ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-purple-900/40 via-[#0f0a1a] to-yellow-900/20" />
                    )}
                        ...
                        >
                            ...
                            <div className="flex flex-wrap items-center gap-x-6 gap-y-4 text-sm text-slate-300 font-medium">
                                <span className="flex items-center gap-2 bg-black/40 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/5">
                                    <Calendar size={16} className="text-purple-400" /> {post.date}
                                </span>
                                <span className="flex items-center gap-2 bg-black/40 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/5">
                                    <Clock size={16} className="text-yellow-400" /> {post.readTime}
                                </span>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 md:mt-24 relative">
                ...
                <div className="hidden lg:flex flex-col gap-4 absolute -left-16 top-0">
                    <button className="w-10 h-10 rounded-full bg-[#160f24] border border-white/10 flex items-center justify-center text-slate-400 hover:text-purple-400 hover:border-purple-500/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.3)] transition-all">
                        <Share2 size={18} />
                    </button>
                    <button className="w-10 h-10 rounded-full bg-[#160f24] border border-white/10 flex items-center justify-center text-slate-400 hover:text-yellow-400 hover:border-yellow-500/50 hover:shadow-[0_0_15px_rgba(253,224,71,0.3)] transition-all">
                        <Bookmark size={18} />
                    </button>
                </div>
                ...
                >
                    {/* Ambient Glow */}
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 translate-x-1/3" />
                    ...
                    <div
                        className="prose prose-invert prose-lg max-w-none relative z-10
                            ...
                            prose-a:text-yellow-400 prose-a:no-underline hover:prose-a:text-yellow-300 hover:prose-a:underline hover:prose-a:underline-offset-4
                            prose-strong:text-white prose-strong:font-bold prose-strong:bg-purple-500/10 prose-strong:px-1 prose-strong:rounded
                            ...
                            hover:prose-pre:border-purple-500/30 transition-all duration-300
                    ...
                    <div className="mt-20 pt-10 border-t border-white/10 relative z-10">
                        ...
                        <div className="flex flex-wrap gap-3">
                            {post.tags.map(tag => (
                                <span key={tag} className="px-4 py-2 bg-[#0a0514] border border-white/10 rounded-xl text-xs font-bold text-slate-300 hover:border-purple-500/50 hover:text-purple-300 hover:bg-purple-500/5 hover:shadow-[0_0_15px_rgba(139,92,246,0.1)] transition-all cursor-pointer transform hover:-translate-y-1">
                                    #{tag}
                                </span>
                            ))}
                        </div>
